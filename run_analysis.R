...
## Part (1)
## This code merges the training and test sets
...
## Part (2)
## This part extracts the mean and standard deviation
...
## Part (3)
## This part adds names to the data set
...
# Part (4)
# This part labels the data set in the appropriate spots.
...
# Part 5
# This part creates a tidy data set 
